...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "trusty-ether-434318-m3-864061dea084.json"  # For Google Cloud Vision API
...
cred = credentials.Certificate("psykitz-891d8-firebase-adminsdk-l7okt-38b1a73888.json")
